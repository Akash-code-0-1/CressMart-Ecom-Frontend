...
<div className="pt-4 border-t border-gray-200 flex items-center justify-between">
  ...
  {/* Deep Green Track Order Button */}
  {orderData?.tracking_code ? (
    <a
     href={getTrackingUrl(orderData.tracking_code, orderData.courier_name || "") || "#"}
      target="_blank"
      rel="noopener noreferrer"
      className="bg-[#023337] hover:bg-[#012225] text-white text-[11px] font-bold px-4 py-2.5 rounded-lg transition-all flex items-center gap-2 cursor-pointer shadow-sm"
    >
      {t.trackOrderAction}
    </a>
  ) : (
    <span className="text-[11px] text-gray-400 font-medium px-4 py-2 italic">
