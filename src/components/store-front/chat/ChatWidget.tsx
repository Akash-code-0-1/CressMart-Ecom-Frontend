...
//                 className="p-1.5 hover:bg-white/15 rounded-full transition-colors cursor-pointer text-white border-none outline-none bg-transparent"
//               >
//                 <FiX size={16} />
//               </button>
//             </div>
...
/**
 * 🚀 SERVICE: Fetch Chat Settings from Backend
 */
...
const ChatWidget = () => {
  ...
  // 🚀 1. FETCH LIVE SETTINGS (Matched to your Prisma Schema)
