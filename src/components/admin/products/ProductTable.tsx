...
export default function ProductTable() {
  ...
  return (
    <div className="bg-white font-poppins">
      {/* 🚀 BULK DELETE CONTEXTUAL FLOATING HEADER BAR */}
      {selectedIds.length > 0 && (
        <div className="flex items-center justify-between bg-red-50 border border-red-200 px-6 py-3 mx-2 md:mx-10 my-3 rounded-lg transition-all">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white text-xs font-semibold px-4 py-2 rounded-md transition-colors disabled:opacity-50 cursor-pointer"
            >
              <Trash2 size={14} />
