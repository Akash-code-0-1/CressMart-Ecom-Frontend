...
const ShopDomainContent = () => {
  return (
    <div className="pb-20 font-lato animate-in fade-in duration-500">
      ...
      <div className="mb-10">
        ...
        <p className="text-xs font-normal text-gray-400">Configure your custom domain settings.</p>
      </div>
      ...
      <div className="max-w-[850px] mx-auto">
        ...
        <section className="bg-white p-8 rounded-2xl border border-[#FF0000] shadow-sm space-y-5">
          ...
          <div className="space-y-4 text-sm font-normal text-gray-600 leading-relaxed font-poppins text-left">
            <p className="font-semibold text-black">Configure DNS Settings in Cloudflare</p>
            
            <div className="space-y-2">
              <p>The Steps in the Bellow:</p>
              <p>1. Point <span className="font-bold text-black uppercase">A Record for @: 128.199.220.202</span></p>
              <p>2. Point <span className="font-bold text-black uppercase">CNAME Record for www: your_domain.com</span></p>
            </div>

            <p>
              Add the following DNS record to your <span className="font-bold text-black">Cloudflare DNS</span> with <span className="font-bold text-black">TTL: Auto</span> and <br />
              <span className="font-bold text-black">Proxy Status: Proxied</span>. Set <span className="font-bold text-black">SSL</span> mode to <span className="font-bold text-black">Flexible</span>. Allow up to 24 hours for verification.
            </p>
          </div>
        ...
        <div className="mt-12 space-y-6">
          <div className="space-y-2">
            <label className="text-[13px] font-bold text-[#000000] uppercase tracking-wider px-1">Domain Name</label>
            <input 
              type="text"
          ...
          <button className="w-full bg-[#1890FF] text-white py-4 rounded-xl text-[18px] font-bold hover:bg-blue-600 transition-all shadow-md active:scale-[0.98]">
            Save
          </button>
        </div>
