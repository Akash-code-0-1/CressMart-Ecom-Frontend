...
export default function OrderTable() {
  ...
  const [page, setPage] = useState(1);
  const [searchQuery, setSearchQuery] = useState("");
  const tabs = ["All order", "Pending","Confirmed","Delivered", "Canceled", "Returned"];
  ...
  const columns = [
        ...
        return (
          ...
          >
            <img
              ...
              alt=""
              className="rounded-[8px] object-cover h-10 w-10 bg-gray-50  p-1 group-hover:border-[#1DA1F2] transition-all"
            />
            <div className="flex flex-col">
    ...
    },
    {
      ...
      render: (item: any) => (
        <span
          onClick={() => openDetails(item)}
          className="font-semibold text-[14px] text-black cursor-pointer"
        >
    ...
    },
    {
      ...
      render: (item: any) => (
        <div
          onClick={() => openDetails(item)}
          className="flex items-center gap-1.5 text-[#26007F] font-bold cursor-pointer"
        >
          <TrackIcon />
          ...
          <div className="flex items-center gap-2 w-full lg:w-auto">
            <div className="relative flex-grow lg:w-[316px]">
              <input
                ...
                className="w-full bg-[#F9FAFB] rounded-[8px] py-2.5 pl-4 pr-10 text-[14px] text-black border border-transparent focus:ring-2 focus:ring-[#1DA1F2]/30 focus:border-[#1DA1F2] outline-none transition-all"
              />
              <Search
                className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[#4B5563]"
                size={20}
      ...
      >
        ...
        <span className="font-medium">Duplicate Order</span>
          ...
          <div className="px-2">
            ...
            <button className="w-full text-left px-3 py-2.5 text-[14px] text-rose-500 hover:bg-rose-50 rounded-lg flex items-center gap-3 transition-colors group mt-0.5">
              <Trash2
                size={16}
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[10001] p-4 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] shadow-2xl overflow-hidden font-lato flex flex-col text-left">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              <div className="border border-gray-100 rounded-xl overflow-hidden">
                <table className="w-full text-left">
                  <thead className="bg-[#F9FAFB] text-xs font-bold text-gray-500 uppercase">
                    <tr>
                ...
                <div className="w-full md:w-80 space-y-2 font-poppins">
                  <div className="flex justify-between text-gray-500">
                    ...
                    <span className="font-bold text-black">
                      ৳
                      {Number(detailsModal.order.total_amount_due) -
                        Number(detailsModal.order.shipping_fee) +
                        Number(detailsModal.order.discount_amount)}
                    </span>
                  </div>
                  <div className="flex justify-between text-gray-500">
                    <span>Shipping</span>
            ...
            <div className="px-6 py-4 bg-[#F9FAFB] border-t border-gray-100 flex justify-end gap-3">
              <button
                onClick={() => setDetailsModal({ open: false, order: null })}
                className="px-6 py-2 bg-white border border-gray-200 rounded-lg text-sm font-bold text-gray-600 hover:bg-gray-50 cursor-pointer"
              >
                Close
              </button>
              <button
                onClick={() => {
                  router.push(
                    `/admin/dashboard/order/add?id=${detailsModal.order.id}`,
                  );
                  setDetailsModal({ open: false, order: null });
                }}
                className="px-6 py-2 bg-[#1DA1F2] text-white rounded-lg text-sm font-bold flex items-center gap-2 shadow-md hover:bg-blue-600 cursor-pointer"
              >
          ...
          <div className="bg-white rounded-[12px] w-full max-w-sm shadow-2xl p-6">
            ...
            <div className="space-y-4">
              <div className="space-y-1 text-left">
                ...
                <select
                  className="w-full p-3 bg-gray-50 border border-gray-200 rounded-[8px] outline-none focus:ring-1 focus:ring-blue-400"
              ...
              <div className="flex gap-3 pt-2">
                <button
                  ...
                  className="cursor-pointer flex-1 py-3 border border-gray-200 rounded-[8px] font-bold text-gray-500 hover:bg-gray-50 transition-all"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="cursor-pointer flex-1 py-3 bg-[#1DA1F2] text-white rounded-[8px] font-bold hover:bg-blue-600 transition-all disabled:bg-gray-300"
                >
